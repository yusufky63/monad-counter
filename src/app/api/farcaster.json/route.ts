...
export async function GET() {
  ...
  const appUrl = (
    process.env.NEXT_PUBLIC_URL || "https://monad-counter.vercel.app"
  ).replace("http://", "https://");
  ...
  const farcasterConfig = {
    ...
    accountAssociation: {
      ...
      signature:
        "MHgyMjMyYWRmMWY5NTJiN2UxM2UwYzU3YTdlNGNiNmNlODNhNWIzMjk5ZDY1YjQyZjJkNDZiY2FmNmZmZmYyM2ZhNThiZjRkNGU2OThmYTM4OWVlM2RhNmIwYjZkODAyNjdmOGMyMWEyNDIwMDhkM2RlMjlkNjMxMzYyYjI4NjUwMzFj",
    },
    miniapp: {
      version: "1",
      name: "Monad Counter",
      ...
      screenshotUrls: ["https://monad-counter.vercel.app/images/feed.png"],
